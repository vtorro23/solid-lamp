...
\end{eg}
Resulta útil formular una condición equivalente para decir que $\displaystyle f $ no es uniformemente continua en $\displaystyle A $.
\begin{fprop}[Criterios de continuidad no uniforme]
...
\end{proof}
\begin{fdefinition}[Función de Lipschitz]
...
\end{proof}
\begin{ftheorem}[Teorema de la extensión continua]
