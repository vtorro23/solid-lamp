...
\end{theorem}
\begin{proof}
La primera implicación es cierta para cualquier subconjunto de $\displaystyle \R^{n} $, por lo que demostraremos únicamente la segunda implicación. Supongamos que $\displaystyle K $ no tiene contenido nulo.
\end{proof}
