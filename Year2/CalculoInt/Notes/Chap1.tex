...
\[\int _{R'}g= \int _{R}g  .\]
Como $\displaystyle f $ es suma de funciones integrables, tendremos que 
\[\int _{R}f =\int _{R}g + h = \int _{R}g +\int _{R}h  = \int _{R'}g  .\]
...
\begin{prop}[Linealidad y monotonía]
\end{prop}
