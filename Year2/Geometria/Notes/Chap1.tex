...
\item[(v)] Los haces son disjuntos dos a dos, por ser una relación de equivalencia. Por tanto, 
...
\begin{notation}
	...
	\[u = \left\{ \left(x_{0}, x_{1}, x_{2}\right) \; : \; ax_{0} + bx_{1} + cx_{2} = 0\right\}  .\]
...
\[\overline{\mathcal{R}} = \mathcal{R} \cup \{\overline{l}_{\infty}\} = \left\{ \overline{l} = \left\{ ax_{1} + bx_{2} = cx_{0} \; : \; \left(a,b\right) \neq \left(0,0\right)\right\} \right\} \cup \left\{ x_{0} = 0\right\}  .\]
\end{eg}
