...
\end{lema}
\begin{proof}
	Sean $\displaystyle \vec{a}, \vec{b}, \vec{c}, \vec{d} \in \K^{3} $ tales que $\displaystyle A = L\left(\vec{a}\right) $, $\displaystyle B = L\left(\vec{b}\right) $, $\displaystyle C = L\left(\vec{c}\right) $ y $\displaystyle D = L\left(\vec{d}\right) $. Si $\displaystyle A \neq B $, tenemos que $\displaystyle \left\{ \vec{a}, \vec{b}\right\}  $ son linealmente independientes. 
...
\begin{center}
	\includegraphics[scale=0.5]{~/Desktop/Images/plano_moulton.png}
\end{center}
Tenemos que  
...
\end{eg}
Recordemos que $\displaystyle \mathbb{P}\left(\K^{3}\right) = \left\{ [x_{0} : x_{1} : x_{2}] \; : \; \left(x_{0}, x_{1}, x_{2}\right) \in \K^{3} / \left\{ 0\right\} \right\}  $. Tenemos que
\[[x_{0}:x_{1}:x_{2}] = [y_{0}:y_{1}:y_{2}] \iff \exists \lambda \in \K/ \left\{ 0\right\}, \; \left(x_{0}, x_{1}, x_{2}\right) = \lambda \left(y_{0}, y_{1}, y_{2}\right) .\]
Las rectas las definimos de la forma
\[ \overline{l} = \left\{ [x_{0}:x_{1}:x_{2}] \; : \; ax_{0} + bx_{1} +cx_{2} = 0\right\}, \; \left(a,b,c\right) \neq \left(0,0,0\right) .\]
\[\overline{l}\left([a_{0}:a_{1}:a_{2}], [b_{0},b_{1},b_{2}]\right) = \left\{ \begin{vmatrix} x_{0} & x_{1} & x_{2} \\ a_{0} & a_{1} & a_{2} \\ b_{0} & b_{1} & b_{2} \end{vmatrix} = 0\right\}  .\]
