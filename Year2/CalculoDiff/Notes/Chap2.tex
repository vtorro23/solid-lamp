...
\item Sea $\displaystyle f : \R^{3} \to \R $ con 
	...
	\frac{1}{\sqrt{x^{2}+y^{2}+z^{2}}}, \; \sqrt{x^{2}+y^{2}+z^{2}} \geq 1
	\end{cases}
	.\]
	Podemos considerar 
