...
\item[(c)] $\displaystyle Q $ es \textbf{indefinida} si existen $\displaystyle h_{1}, h_{2} \in \R^{n} $ tales que $\displaystyle Q\left(h_{1}\right) > 0 $ y $\displaystyle Q\left(h_{2}\right) < 0 $.
\end{description}
\end{definition}
...
\item Si $\displaystyle \det\left(A\right) \neq 0 $ y no se cumple ninguna de las condiciones entonces es indefinida. 
\end{itemize}
\end{theorem}
\begin{notation}
