\part{Grupos}
\chapter{Generalidades de grupos}
...
\begin{proof}
	...
	Dado que $\displaystyle a^{l}, \left(a^{k}\right)^{q} \in H $, debe ser que $\displaystyle a^{r} \in H $. Como $\displaystyle k \in \N $ era el menor tal que $\displaystyle a^{k} \in H $ y $\displaystyle r < k $, debe ser que $\displaystyle r = 0 $, por lo que $\displaystyle x = a^{l} = \left(a^{k}\right)^{q} \in H $. Así, hemos visto que $\displaystyle H \subset \left\langle a^{k} \right\rangle  $.
