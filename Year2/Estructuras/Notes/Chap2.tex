...
\end{proof}
\begin{observation}
Este resultado nos permite establecer una biyección entre el número de subgrupos de $\displaystyle G $ que contienen a un subgrupo normal $\displaystyle H $ y subgrupos de $\displaystyle G/H $. 
\end{observation}
