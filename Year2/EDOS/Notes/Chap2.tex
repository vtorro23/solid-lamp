...
es exacta puesto que $\displaystyle \frac{\partial \widetilde{M}}{\partial x}= \frac{\partial \tilde{N}}{\partial t} $. A $\displaystyle \mu $ lo llamamos \textbf{factor integrante}. Si no nos dan alguna información de $\displaystyle \mu $ para que lo podeamos calcular, no podemos calcular $\displaystyle \mu $ ni la solución de la EDO (sería una EDP muy complicada).
\end{observation}
